...
if ( TRACE ) { TRACE( "AICarController#init", this ); }
                ...
                this.moveVelocity3 = new UnityEngine.Vector3();
                this.moveSpeed = 10.0;
                this.maxSpeed = 20.0;
                this.smoothTime = 0.2;
                ...
                this.moveVelocity3 = pc.Vec3.ZERO.clone();
...
if ( TRACE ) { TRACE( "AICarController#Update", this ); }
                ...
                if (GameManager.Instance.isStartGame) {
                    ...
                    this.turnAmount = angleToTarget * this.turnSpeed * UnityEngine.Time.deltaTime;
...
if ( TRACE ) { TRACE( "AICarController#speedUp", this ); }
                ...
                switch (mapType) {
                    case MapType.Summer: 
                        this.speedUpTime = 5;
                        this.speedUpMoving = 1500;
                        break;
                    case MapType.Rainy: 
                        this.speedUpTime = 6;
                        this.speedUpMoving = 2000;
                        break;
                    case MapType.Winter: 
                        this.speedUpTime = 7;
                        ...
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    this.IdleEngineEffect.SetActive(true);
                                        this.audioSource.Stop();
                                        this.audioSource.clip = this.IdleEngineSound;
                                        this.audioSource.Play();
                                        this.audioSource.loop = true;
...
if ( TRACE ) { TRACE( "PlayerCarController#HandleInput", this ); }
                ...
                if (UnityEngine.Input.touchCount > 0) {
                    ...
                    var percent = Math.max(-1.0, Math.min(-delta, 1.0));
